      ...
      const { product } = this.props;
        ...
        return (
            <ProductWrapper className="col-9 mx-auto col-md-6 col-lg-3 my-3">
                <div className="card">
                    <div className="img-container p-5" onClick={() => console.log('fetching pdetail')}>
                        <Link to="/details">
                            {/* <img src={product.img} alt="product" className="card-img-top"/> */}
                        </Link>
                        <button className="cart-btn" disabled={product.inCart ? true: false} onClick={() => console.log('added to the cart')}>
