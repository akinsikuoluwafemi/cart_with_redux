...
import {incrementAction, decrementAction, removeItemAction } from '../../actions';
 ...
 function CartItem({item}) {
    console.log(item)
     const { id, title, img, price, total, count, incrementAction, decrementAction, removeItemAction } = item;
        ...
        <div className="col-10 mx-auto col-lg-2">
            ...
            <div className="col-10 mx-auto col-lg-2 my-2 my-lg-0">
                <div className="d-flex justify-content-center">
                    <div>
                        <span className=" btn btn-black mx-1" onClick={() => decrementAction(id)}>
                            -</span> 
                    </div>
                </div>
            </div>
