  ...
  switch (action.type) {
    ...
    case FETCH_PRODUCTS:
      ...
      case DECREMENT:
          ...
          const theSelectedProduct = tempCart.find(item => item.id === action.payload)
          const indexx = tempCart.indexOf(theSelectedProduct);
          const productDeInCart = tempCart[indexx];

          productDeInCart.count = productDeInCart.count - 1;
          productDeInCart.total = productDeInCart.count * productDeInCart.price;
