  ...
  switch (action.type) {
    ...
    case FETCH_PRODUCTS:
      ...
      case DECREMENT:
          ...
          let theSelectedProduct = tempDecCart.find(item => item.id === action.payload)
          let indexx = tempDecCart.indexOf(theSelectedProduct);
          let productDecInCart = tempDecCart[indexx];
